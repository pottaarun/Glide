/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: f6c62a23d6c29ce5f8f2ab1bd9c5d844)
...
interface __BaseEnv_Env {
	...
	GlideAgent: DurableObjectNamespace<import("./src/server").GlideAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GlideAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GLIDE_MODEL" | "GLIDE_EMBED_MODEL">> {}
}
